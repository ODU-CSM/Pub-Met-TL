...
# import tf.keras as kr
# import tensorflow_addons as tfa

from transfer import callbacks as cbk
from transfer import data as dat
from transfer import metrics as met
from transfer import models as mod
from transfer.models.utils import is_input_layer, is_output_layer
from transfer.data import hdf, OUTPUT_SEP
from transfer.utils import format_table, make_dir, EPS
from transfer import utils
from transfer import metrics
...
class App(object):
    ...
    def main(self, name, opts):
        ...
        model.compile(optimizer=optimizer,
                      loss=mod.get_objectives(output_names, opts.loss_fn),
        ...
        data_reader = mod.data_reader_from_model(
            model, replicate_names=replicate_names, loss_fn=opts.loss_fn)
